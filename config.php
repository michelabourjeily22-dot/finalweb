...
function addCarListing($carData, $imagePaths) {
    ...
    $carId = 'car' . time() . rand(1000, 9999);
        ...
        $stmt = $pdo->prepare("
            INSERT INTO cars (id, make, model, vehicle_type, year, mileage, color, transmission, fuel_type, price, country, city, user_id, seller_name)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
